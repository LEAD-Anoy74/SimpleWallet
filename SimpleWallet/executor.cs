...
namespace SimpleWallet
{
    class Executor
    {
        ...
        public bool checkParamsFile(String file1, String file2)
        {
            ...
            String file1Loc = appdata + "\\ZeroParams\\" + file1;
            String file2Loc = appdata + "\\ZeroParams\\" + file2;
            Int64 length = 0;
            WebClient wc = new WebClient();
            Stream response = null;
            if (!Directory.Exists(appdata + "\\ZeroParams"))
            {
                Directory.CreateDirectory(appdata + "\\ZeroParams");
                return true;
            }
        ...
        public bool downloadParams(String file, Types.DownloadFileType downloadType)
        {
            ...
            String appdata = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
            String fileLoc = appdata + "\\ZeroParams\\" + file;
            Int64 length = 0;
            WebClient wc = new WebClient();
            Stream response = null;
            Int64 bytes_total = 0;
            ...
            if(shouldDownload)
            {
                ...
                wc.DownloadFileAsync(new System.Uri(fileLink), appdata + "\\ZeroParams\\" + file, true);
            }
